...
function authorize(){
	...
	api_getViewerProfile();
}

function sapi_init(data,callback){
	var data = {
...
function api_getViewerProfile(callback){
	VK.api('getProfiles',{
...
function getPlaceByCoord(){
	// Запускает процесс геокодирования
	var geocoder = new YMaps.Geocoder(new YMaps.GeoPoint(37.588395, 55.762718), {
		results: 1
	});
